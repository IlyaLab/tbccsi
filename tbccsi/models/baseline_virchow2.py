#!/usr/bin/env python3
"""
Baseline Linear Probe for Macrophage Count Regression
...
def extract_embeddings(
    ...
    Identical to domain_specific_frozen_codex_7.py — embeddings can be shared
    between the baseline and the full model.
    """
...
def main():
    parser = argparse.ArgumentParser(
        description="Baseline Linear Probe for Macrophage Count Regression"
    )
